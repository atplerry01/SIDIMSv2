    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.SidSector", t => t.SidSectorId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.SidSector", t => t.SectorId, cascadeDelete: false)
                .Index(t => t.SectorId);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Job", t => t.JobId, cascadeDelete: true)
                .ForeignKey("dbo.SidProduct", t => t.SidProductId, cascadeDelete: false)
                .ForeignKey("dbo.SidVariant", t => t.SidVariantId, cascadeDelete: false)
                .Index(t => t.JobId)
                .Index(t => t.SidProductId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.JobVariant", "SidVariantId", "dbo.SidVariant");
            ...
            DropIndex("dbo.JobVariant", new[] { "SidVariantId" });
            ...
            DropTable("dbo.Sid09MaterialAudit");
