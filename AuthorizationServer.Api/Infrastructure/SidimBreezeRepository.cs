...
namespace AuthorizationServer.Api.Infrastructure
{
    public class SidimBreezeRepository
    {
        ...
        public IQueryable<Sid07Mailing> Sid07Mailings
        {
            get { return Context.Sid07Mailings; }
        }

        public IQueryable<Sid08Dispatch> Sid08Dispatchs
        {
            get { return Context.Sid08Dispatchs; }
        }

        public IQueryable<Sid09MaterialAudit> Sid09MaterialAudits
        {
            get { return Context.Sid09MaterialAudits; }
        }
        ...
        /// Sid Repository
        /// </summary>
        public IQueryable<Sid08Dispatch> Sid08Dispatch
        {
            get { return Context.Sid08Dispatchs; }
        }
        ...
        public IQueryable<PrintDelivery> PrintDelivery
        {
            get { return Context.PrintDelivery; }
        }
