(function () {
    ...
    ResumableNewPersoDetailCE.$inject = ['$location', '$routeParams', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function ResumableNewPersoDetailCE($location, $routeParams, $scope, common, datacontext, model, resourceService) {
        ...
        function activate() {
            var promises = [getRequestedJob(), getProductionStaffs()];
