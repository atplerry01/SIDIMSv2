(function () {
    ...
    JobRunQC.$inject = ['$location', '$routeParams', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function JobRunQC($location, $routeParams, $scope, common, datacontext, model, resourceService) {
        ...
        function activate() {
            var promises = [getRequestedJob(), getCardIssuanceLogs(), getCardDeliveryLogs(), getProductionUsers()];
