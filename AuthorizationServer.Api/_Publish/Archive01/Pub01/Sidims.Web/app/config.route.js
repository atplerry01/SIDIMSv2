        ...
        return [
            {
                ...
                config: {
                    title: 'Job Status',
                    templateUrl: 'app/cardops/job/jobstatus.co.html', //app/cardops/job/jobstatus.co.html
                ...
                url: '/in/dispatch/receive-job/:id', // receive incoming Jobs
                config: {
                    title: 'Card Variant Details',
                ...
                url: '/sa/dashboard-socials',
                config: {
                    title: 'signup',
                    templateUrl: 'app/sadmin/dashboard/socials.html',
                    settings: {
                        nav: 2,
                        content: '<i class="fa fa-lock"></i> Admin'
                    },
                ...
                url: '/sa/account-admin',
                config: {
                    title: 'Admin Accounts',
                    templateUrl: 'app/sadmin/accounts/admin.html',
                    settings: {
                        nav: 2,
                        content: '<i class="fa fa-lock"></i> Admin'
                    }
                ...
                url: '/sa/accounts/new-profiles',
                config: {
                    title: 'Students Account',
                    templateUrl: 'app/sadmin/accounts/newprofile.sa.html',
                    controller: 'NewProfileSa',
                    controllerAs: 'vm',
                    settings: {
                        nav: 2,
                        content: '<i class="fa fa-lock"></i> Admin'
                ...
                url: '/sa/accounts/students',
                config: {
                    title: 'Students Account',
                    templateUrl: 'app/sadmin/accounts/students.sa.html',
                    controller: 'StudentSa',
                    controllerAs: 'vm',
                    settings: {
                        nav: 2,
                        content: '<i class="fa fa-lock"></i> Admin'
                ...
                url: '/sa/accounts/teachers',
                config: {
                    title: 'Students Account',
                    templateUrl: 'app/sadmin/accounts/teachers.sa.html',
                    controller: 'TeacherSa',
                    controllerAs: 'vm',
                    settings: {
                        nav: 2,
                        content: '<i class="fa fa-lock"></i> Admin'
                ...
                url: '/sa/accounts/librarians',
                config: {
                    title: 'Students Account',
                    templateUrl: 'app/sadmin/accounts/librarians.sa.html',
                    controller: 'LibrarianSa',
                    controllerAs: 'vm',
                    settings: {
                        nav: 2,
                        content: '<i class="fa fa-lock"></i> Admin'
                ...
                url: '/sa/accounts/accountants',
                config: {
                    title: 'Students Account',
                    templateUrl: 'app/sadmin/accounts/accountants.sa.html',
                    controller: 'AccountantSa',
                    controllerAs: 'vm',
                    settings: {
                        nav: 2,
                        content: '<i class="fa fa-lock"></i> Admin'
                ...
                url: '/sa/accounts/managements',
                config: {
                    title: 'Students Account',
                    templateUrl: 'app/sadmin/accounts/managements.sa.html',
                    controller: 'ManagementSa',
                    controllerAs: 'vm',
                    settings: {
                        nav: 2,
                        content: '<i class="fa fa-lock"></i> Admin'
                ...
                url: '/sa/accounts/administrations',
                config: {
                    title: 'Students Account',
                    templateUrl: 'app/sadmin/accounts/administrations.sa.html',
                    controller: 'AdministrationSa',
                    controllerAs: 'vm',
                    settings: {
                        nav: 2,
                        content: '<i class="fa fa-lock"></i> Admin'
                ...
                url: '/sa/accounts/parents',
                config: {
                    title: 'Students Account',
                    templateUrl: 'app/sadmin/accounts/parents.sa.html',
                    controller: 'ParentSa',
                    controllerAs: 'vm',
                    settings: {
                        nav: 2,
                ...
                url: '/sa/accounts/role-assignment/:id',
                config: {
                    title: 'Students Account',
                    templateUrl: 'app/sadmin/accounts/roleassignment.sa.html',
                    controller: 'RoleAssignmentSa',
                    controllerAs: 'vm',
                    settings: {
                        nav: 2,
                        content: '<i class="fa fa-lock"></i> Admin'
                ...
                url: '/sa/accounts/user-profiles',
                config: {
                    title: 'Students Account',
                    templateUrl: 'app/sadmin/accounts/userprofiles.sa.html',
                    controller: 'UserProfileSa',
                    controllerAs: 'vm',
                    settings: {
                        nav: 2,
                        content: '<i class="fa fa-lock"></i> Admin'
                ...
                url: '/sa/accounts/userprofile/:id',
                config: {
                    title: 'Students Account',
                    templateUrl: 'app/sadmin/accounts/userprofiledetail.sa.html',
                    controller: 'UserProfileDetailSa',
                    controllerAs: 'vm',
                    settings: {
                        nav: 2,
                        content: '<i class="fa fa-lock"></i> Admin'
