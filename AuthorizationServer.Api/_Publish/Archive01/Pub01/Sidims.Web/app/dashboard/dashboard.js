(function () {
    ...
    dashboard.$inject = ['$location', '$route', '$rootScope', '$scope', 'authService', 'common', 'config', 'datacontext', 'model', 'resourceService'];

    function dashboard($location, $route, $rootScope, $scope, authService, common, config, datacontext, model, resourceService) {
