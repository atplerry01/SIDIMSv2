(function () {
    ...
    JobStatus.$inject = ['$location', '$routeParams', '$scope', 'common', 'config', 'datacontext', 'model', 'resourceService'];

    function JobStatus($location, $routeParams, $scope, common, config, datacontext, model, resourceService) {
