    ...
    function RepositoryResource($routeParams, common, authService, model, AbstractRepository) {
        ...
        function getJobs(forceRemote) {
            ...
            return EntityQuery.from('InventoryJobs')
                .select('id, jobName, jobNameId, sidSectorId, sidClientId, serviceTypeId, remarkId, jobStatusId, quantity')
                .toType('Job')
        ...
        function getPartialJobs(forceRemote) {
            ...
            return EntityQuery.from('InventoryPartialJobs')
                //id, jobName, sidSectorId, sidClientId, serviceTypeId, sidCardTypeId, jobStatusId, quantity
        ...
        function getCardIssuances(forceRemote) {
            ...
            return EntityQuery.from('CardIssuances')
                .select('id, jobId, jobTrackerId, collectorId, issuanceId, issuanceStatusId, totalQuantity, totalQuantityIssued, totalQuantityRemain')
                .toType('CardIssuance')
                .using(self.manager).execute()
                .then(querySucceeded, self._queryFailed);
