(function () {
    ...
    function RepositoryResource($routeParams, common, authService, model, AbstractRepository) {
        ...
        //    return EntityQuery.from('IncomingPrintByBatchTrackers')
        ...
        //        //self.log('Retrieved [JobBatchTracker Partials] from remote data source', entity.length, true);
        //        return entity;
        //    }
        //}
        ...
        function getJobSplitPrintCEAnalysis(jobTrackerId, forceRemote) {
            ...
            return EntityQuery.from('PrintAnalysisByTrackerId')
