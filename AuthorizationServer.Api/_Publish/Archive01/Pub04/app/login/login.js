(function () {
    ...
    login.$inject = ['$layout', '$location', '$scope', '$rootScope', '$window', 'accountService', 'authService', 'common', 'localStorageService'];

    function login($layout, $location, $scope, $rootScope, $window, accountService, authService, common, localStorageService) {
